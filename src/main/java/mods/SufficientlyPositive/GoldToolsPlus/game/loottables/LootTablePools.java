...
public class LootTablePools {
    ...
    static {
        ...
        BASTION_BRIDGE_TOOLS = FabricLootPoolBuilder.builder()
                ...
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_SWORD).weight(5))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_SHOVEL).weight(3))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_PICKAXE).weight(5))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_AXE).weight(5))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_HOE).weight(1));

        BASTION_OTHER_TOOLS = FabricLootPoolBuilder.builder()
                .rolls(BinomialLootNumberProvider.create(1, 0.15F))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_SWORD).weight(2))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_SHOVEL).weight(5))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_PICKAXE).weight(5))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_AXE).weight(5))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_HOE).weight(2));

        BASTION_TREASURE_TOOLS = FabricLootPoolBuilder.builder()
                .rolls(BinomialLootNumberProvider.create(2, 0.2F))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_SWORD).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_AXE).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_PICKAXE).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_HELMET).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_CHESTPLATE).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_LEGGINGS).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_BOOTS).apply(EnchantRandomlyLootFunction.builder()));

        END_CITY_TOOLS = FabricLootPoolBuilder.builder()
                .rolls(BinomialLootNumberProvider.create(2, 0.125F))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_SWORD).weight(3).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_SHOVEL).weight(6).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_PICKAXE).weight(6).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_AXE).weight(6).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_HELMET).weight(2).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_CHESTPLATE).weight(2).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_LEGGINGS).weight(2).apply(EnchantRandomlyLootFunction.builder()))
                .with(ItemEntry.builder(ItemsInit.WHITE_GOLD_BOOTS).weight(2).apply(EnchantRandomlyLootFunction.builder()));
    }
}
