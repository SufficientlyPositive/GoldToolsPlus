package mods.SufficientlyPositive.GoldToolsPlus.game.slots;
...
public class InfusingResultSlot extends Slot {

    private final PlayerEntity player;
    private final CraftingInventory input;
    private int amount;

    public InfusingResultSlot(PlayerEntity player, CraftingInventory input, Inventory inventory, int index, int x, int y) {
    ...
    public void onTakeItem(PlayerEntity player, ItemStack stack) {
        this.onCrafted(stack);
        DefaultedList<ItemStack> defaultedList = player.world.getRecipeManager().getRemainingStacks(RecipeInit.INFUSER_RECIPE_TYPE, this.input, player.world);
